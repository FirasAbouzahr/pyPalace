...
<img src="Figures/attributes_dataframe.png" width="200">
...
now let's add config["Domains"] and config["Boundaries"] using our material and BC lists defined above. I will update this example with some postprocessing and adaptive mesh refinement soon to help better showcase all capabilities.
```python
